            ...
            <div class="col-sm-<?php echo juno_main_width(); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div id="single-image-container" style="background-image: url(<?php echo has_post_thumbnail() ? esc_url( the_post_thumbnail_url() ) : get_template_directory_uri() . '/inc/images/blog-post-default.jpg'; ?>);">
